    ...
    <html lang="fr">
      <body className={inter.className}>
        ...
        <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 hidden lg:block promotional-banner-desktop">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-6 py-3 rounded-t-lg shadow-2xl border-t-2 border-x-2 border-white/20">
            <div className="flex items-center justify-center space-x-2">
              <span className="text-sm font-bold whitespace-nowrap">
                🎉 Quand NERYTEC vous trouve un job, NERYTEC vous offre 1000€ ! 🎉
              </span>
              <span className="text-xs whitespace-nowrap opacity-80">*en chèque cadeau de votre choix</span>
            </div>
          </div>
        </div>
        ...
        <div className="fixed top-0 left-0 right-0 z-50 lg:hidden">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-4 py-2 text-center shadow-lg">
