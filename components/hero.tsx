    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 lg:pt-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-8 border border-white/20">
          <h1 className="text-4xl md:text-6xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in-up drop-shadow-lg">
            <span className="text-[#0078BE] drop-shadow-2xl">NERYTEC</span> <span className="font-normal text-white">CONSULTING</span>
            <span className="block text-white pb-2 drop-shadow-lg">
        ...
        <div
          className="flex flex-wrap justify-center items-center gap-8 text-white animate-fade-in-up bg-black/20 backdrop-blur-sm rounded-2xl p-4 border border-white/10"
          style={{ animationDelay: "0.9s" }}
        >
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-[#0078BE] rounded-full animate-sparkle shadow-lg" />
            <span className="text-sm font-medium drop-shadow-md">500+ placements réussis</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-[#0078BE] rounded-full animate-sparkle shadow-lg" />
      ...
      >
        ...
        >
          <div className="w-8 h-12 border-2 border-white/60 rounded-full flex justify-center relative overflow-hidden group-hover:border-white/80 transition-all duration-300 group-hover:shadow-lg group-hover:shadow-white/20 backdrop-blur-sm">
            {/* Animated scroll line */}
            <div className="w-0.5 h-4 bg-gradient-to-b from-white/80 to-transparent rounded-full mt-2 animate-scroll-bounce group-hover:from-[#0078BE] group-hover:to-purple-400 transition-all duration-300" />
          ...
          {/* Scroll text hint */}
          <div className="text-white/80 text-xs mt-2 text-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-1 group-hover:translate-y-0 drop-shadow-md">
            Scroll
          </div>
        </div>
      </div>
