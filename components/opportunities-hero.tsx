...
export function OpportunitiesHero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50 to-pink-50">
      <div className="absolute inset-0">
        <div
          className="absolute top-1/4 left-1/4 w-32 h-32 bg-orange-300/20 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "0s" }}
        />
        <div
          className="absolute bottom-1/3 right-1/4 w-48 h-48 bg-pink-300/20 rounded-full blur-3xl animate-float"
      ...
      <div ref={ref} className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Découvrez les meilleures opportunités de carrière dans votre domaine
        </p>
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium">Postes exclusifs</span>
          </div>
          <div className="flex items-center space-x-2">
            <TrendingUp className="w-5 h-5 text-orange-500" />
            <span className="font-medium">Évolution rapide</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="font-medium">Entreprises premium</span>
          </div>
        </div>
      </div>
    </section>
